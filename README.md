# [Сертификат о выпуске](https://disk.yandex.ru/i/XYApVAFX2V_ZLg)
...
В каждой папке проекта есть README  с кратким описанием проекта, а также тетрадка notebook (.ipynb) c кодом
...
## 📊Проекты, связанные с обработкой и анализом данных:
...
- **[Сборный проект 1](Сборный%20проект%201.%20Анализ%20рынка%20игровой%20индустрии)**  
...
- **[Машинное обучение в бизнесе](Машинное%20обучение%20в%20бизнесе.%20Выбор%20региона%20нефтедобычи)**  
...
- **[Машинное обучение для текстов](Машинное%20обучение%20для%20текстов.%20Классификациия%20комментариев)**  
...
- **[Deep learning. Компьютерное зрение](Deep%20learning.%20Компьютерное%20зрение)**  
...
- **[Выпускной проект](Выпускной%20проект.%20Прогнозирование%20температуры%20стали)** 
  ...
  Инструменты:
  > Scikit-learn, Seaborn, Matplotlib, Pandas, Python
## 👽Прочие проекты:
